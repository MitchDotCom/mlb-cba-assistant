...
// Works on Vercel/Next by using dynamic ESM import for pdfjs-dist (no worker needed).
...
// Dynamically import the ESM module only when needed (fixes Next/Vercel ESM error)
async function getPdfjs() {
  // In pdfjs-dist v4, getDocument is a named export
  const mod = await import('pdfjs-dist');
  // Some environments attach exports under default; guard just in case
  return {

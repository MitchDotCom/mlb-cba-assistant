...
// Use your working git-main domain
...
// === Your original system instructions (verbatim) ===
...
// Force a Markdown link + raw URL so it’s clickable in all UIs
const VERIFY_TEMPLATE = (pdfUrl) => `
Append the following block exactly after your normal answer:

—— Verification ——
• Open PDF: [Open page](${pdfUrl}#page=<n>)
  Raw: ${pdfUrl}#page=<n>
